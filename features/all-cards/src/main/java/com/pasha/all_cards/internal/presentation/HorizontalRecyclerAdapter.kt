...
import com.pasha.all_cards.databinding.ItemSmallCardLayoutBinding
...
class HorizontalRecyclerAdapter(
...
) : RecyclerView.Adapter<HorizontalRecyclerAdapter.CardViewHolder>() {
    private val cards = mutableListOf<Card>()

    class CardViewHolder(
        private val binding: ItemSmallCardLayoutBinding,
        private val onCardClick: (Card) -> Unit,
        private val onDeleteClick: (Card) -> Unit
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CardViewHolder {
        ...
        val binding = ItemSmallCardLayoutBinding.inflate(layoutInflater, parent, false)
...
class HorizontalSpacingItemDecoration(private val horizontalSpaceHeight: Int) : RecyclerView.ItemDecoration() {
